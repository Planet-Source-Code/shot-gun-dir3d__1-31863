...
Private dmA As DMUS_AUDIOPARAMS

Global Sound1                      As DirectSoundSecondaryBuffer8
Global Sound2                      As DirectSoundSecondaryBuffer8
Global Sound3                      As DirectSoundSecondaryBuffer8
Global Sound4                      As DirectSoundSecondaryBuffer8
Global Sound5                      As DirectSoundSecondaryBuffer8
Global Sound6                      As DirectSoundSecondaryBuffer8
Global Sound7                      As DirectSoundSecondaryBuffer8
Global Sound8                      As DirectSoundSecondaryBuffer8
...
Public tBar As Direct3DSurface8
...
Public Function D3DUtil_Init(hwnd As Long, bWindowed As Boolean, AdapterIndex As Long, modeIndex As Long, devtype As CONST_D3DDEVTYPE, CallbackObject As Object) As Boolean
    ...
    End If
      ...
      ' initialize some sound
     Set DS = g_dx.DirectSoundCreate("")

    ' Check the pointer is valid
     If DS Is Nothing Then GoTo errOut
     
     ' Set cooperative level, we only need normal functionality
DS.SetCooperativeLevel frmMain.hwnd, DSSCL_NORMAL

Set Sound1 = DS.CreateSoundBufferFromFile(m_Mediadir & "Sound\up.wav", SoundDesc)
' Check the pointer is valid
If Sound1 Is Nothing Then GoTo errOut

Set Sound2 = DS.CreateSoundBufferFromFile(m_Mediadir & "Sound\away.wav", SoundDesc)
' Check the pointer is valid
If Sound2 Is Nothing Then GoTo errOut

Set Sound3 = DS.CreateSoundBufferFromFile(m_Mediadir & "Sound\start.wav", SoundDesc)
' Check the pointer is valid
If Sound3 Is Nothing Then GoTo errOut

Set Sound4 = DS.CreateSoundBufferFromFile(m_Mediadir & "Sound\move.wav", SoundDesc)
' Check the pointer is valid
If Sound4 Is Nothing Then GoTo errOut

Set Sound5 = DS.CreateSoundBufferFromFile(m_Mediadir & "Sound\bak.wav", SoundDesc)
' Check the pointer is valid
If Sound5 Is Nothing Then GoTo errOut

Set Sound6 = DS.CreateSoundBufferFromFile(m_Mediadir & "Sound\dir.wav", SoundDesc)
' Check the pointer is valid
If Sound6 Is Nothing Then GoTo errOut

Set Sound7 = DS.CreateSoundBufferFromFile(m_Mediadir & "Sound\clk.wav", SoundDesc)
' Check the pointer is valid
If Sound7 Is Nothing Then GoTo errOut

Set Sound8 = DS.CreateSoundBufferFromFile(m_Mediadir & "Sound\scrp.wav", SoundDesc)
' Check the pointer is valid
If Sound8 Is Nothing Then GoTo errOut


 'Dim fileName As String, tFile As String
 'Dim wavFor As WAVEFORMATEX
 
    'Set dml = g_dx.DirectMusicLoaderCreate
    'Set dmp = g_dx.DirectMusicPerformanceCreate
    
    'dml.SetSearchDirectory App.Path & "\Sound\"
 
    'dmp.InitAudio frmMain.hwnd, DMUS_AUDIOF_ALL, dmA
    ...
    'Set dmSeg = dml.LoadSegment("music.mid")
...
Function D3DUtil_InitWindowed(hwnd As Long, AdapterIndex As Long, devtype As CONST_D3DDEVTYPE, bTryFallbacks As Boolean) As Boolean
    ...
    Call g_dev.SetRenderState(D3DRS_ALPHABLENDENABLE, 1)
