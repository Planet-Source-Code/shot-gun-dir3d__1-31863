...
'-----------------------------------------------------------------------------
Function D3DUtil_LoadFromFile(strFile As String, parentFrame As CD3DFrame, parentAnimation As CD3DAnimation, Name As String, iType As TypeEnum) As CD3DFrame
    On Local Error GoTo errOut
    Dim newFrame As CD3DFrame
    Set newFrame = New CD3DFrame
    
    g_bLoadSkins = False
    newFrame.InitFromFile g_dev, strFile, parentFrame, parentAnimation, Name, iType
